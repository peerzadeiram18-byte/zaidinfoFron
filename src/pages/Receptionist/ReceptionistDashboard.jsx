...
const ReceptionistDashboard = () => {
    ...
    const handleNewWalkInOrder = () => {
        navigate("/receptionist-dashboard/walk-in-order/new");
    };

    /*
    const handleViewOrders = () => {
        navigate("/receptionist-dashboard/walk-in-orders");
    };

    const handleCustomers = () => {
        navigate("/receptionist-dashboard/customers");
    };

    const handleApplyLeave = () => {
        navigate("/receptionist-dashboard/leave/apply");
    };

    const handleMyLeaves = () => {
        navigate("/receptionist-dashboard/leaves");
    };
    */
