...
//                           <span className="rc-device-tag">{latestRepair?.deviceModel || "Standard Device"}</span>
//                         </div>
//                       </td>
//                       <td>
...
//                         <strong className="rc-meta-txt">{repair.deviceModel || "N/A"}</strong>
//                       </div>
//                       <div>
...
//                         <strong className="rc-meta-txt">₹{repair.repairCost || 0}</strong>
//                       </div>
//                     </div>
